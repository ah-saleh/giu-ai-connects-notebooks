...
One notebook per day, built together in the room. All on **LangChain v1**, with
`create_agent` at the center and everything else an argument you add to it.

| Day | Notebook | What you build |
|---|---|---|
| Any | `00-warmup-first-calls.ipynb` | Warm-up: plain `ChatAnthropic` calls (replies, tokens, temperature, streaming). Run it once to verify your setup |
